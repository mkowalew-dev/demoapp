...
const Menuitems: MenuitemsType[] = [
  ...
  //   external: true,
  //   icon: IconHelp,
  //   href: "https://applitools.com/docs/index.html",
  // },
  // {
  //   id: uniqueId(),
  //   title: "Tutorials",
  //   external: true,
  //   icon: IconHelp,
  //   href: "https://www.applitools.com/tutorials",
  // },
  ...
  //   external: true,
  //   icon: IconApps,
  //   href: "https://autonomous.applitools.com",
  // },
  // {
  //   id: uniqueId(),
  //   title: "Eyes",
  //   external: true,
  //   icon: IconApps,
  //   href: "https://eyes.applitools.com",
  // },
  // {
  //   id: uniqueId(),
  //   title: "Preflight",
  //   external: true,
  //   icon: IconApps,
  //   href: "https://preflight.applitools.com",
  // },
];
